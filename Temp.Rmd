...
ggplot(data = yr, mapping = aes(x = year, y = avg)) + 
  geom_line()+
  geom_errorbar(aes(ymin = mean_lwr, ymax = mean_upr))+
  geom_smooth(method = "lm")



#by watershed year
ggplot(data = watershds, mapping = aes(x = year, y = max, color = watershed)) + 
  geom_line(color = "black")+
  geom_errorbar(aes(ymin = max_lwr, ymax = max_upr), color = "black")+
  geom_smooth(method = "lm")

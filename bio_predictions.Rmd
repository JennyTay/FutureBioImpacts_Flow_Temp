...
a <- ggplot(data = biopred, mapping = aes(x = factor(type, levels = c("dry", "moderate", "wet")), y = chub, fill = time))+
  ...
  theme(text = element_text(size=30), panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        ...
        strip.background = element_rect(fill = "lightblue", colour = "black"))+
  facet_wrap(vars(elv), nrow = 1)

b <- ggplot(data = biopred, mapping = aes(x = factor(type, levels = c("dry", "moderate", "wet")), y = sucker, fill = time))+
  geom_boxplot()+ scale_fill_manual(values=c("grey90", "grey60"))+
...
c <- ggplot(data = biopred, mapping = aes(x = factor(type, levels = c("dry", "moderate", "wet")), y = trout, fill = time))+
  geom_boxplot()+ scale_fill_manual(values=c("grey90", "grey60"))+
...
d <- ggplot(data = biopred, mapping = aes(x = factor(type, levels = c("dry", "moderate", "wet")), y = vireo, fill = time))+
  geom_boxplot()+ scale_fill_manual(values=c("grey90", "grey60"))+
  labs(y="P(Occurrence)", x = "Water Year Type", subtitle = "Least Bell's vireo")+
  theme(text = element_text(size=30), panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), panel.border = element_rect(colour = "black", fill=NA, size=.5), legend.position = "none",
        strip.text = element_text(size = 20, face = "bold"),
        strip.background = element_rect(fill = "lightblue", colour = "black"))+
...
e <- ggplot(data = biopred, mapping = aes(x = factor(type, levels = c("dry", "moderate", "wet")), y = toad, fill = time))+
  geom_boxplot()+ scale_fill_manual(values=c("grey90", "grey60"))+
  labs(y=NULL, x = "Water Year Type", subtitle = "Arroyo toad")+
  theme(text = element_text(size=30), panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), panel.border = element_rect(colour = "black", fill=NA, size=.5), legend.position = "none",
        strip.text = element_text(size = 20, face = "bold"),
        strip.background = element_rect(fill = "lightblue", colour = "black"))+
...
f <- ggplot(data = biopred, mapping = aes(x = factor(type, levels = c("dry", "moderate", "wet")), y = turtle, fill = time))+
  geom_boxplot()+ scale_fill_manual(values=c("grey90", "grey60"))+
  labs(y=NULL, x = "Water Year Type", subtitle = "Southwestern pond turtle")+
  theme(text = element_text(size=30), panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), panel.border = element_rect(colour = "black", fill=NA, size=.5), legend.position = "none",
        strip.text = element_text(size = 20, face = "bold"),
        strip.background = element_rect(fill = "lightblue", colour = "black"))+
...
comp3$type <- ifelse(year %in% c(1993, 2095), "wet",
                     ifelse(year %in% c(2100, 2010), "moderate", "dry"))

ggplot(data = comp3, aes(x = factor(year), y = Probability, color = time))+
  geom_violin()+
  facet_wrap(vars(Species, time))
